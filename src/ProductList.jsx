...
function ProductList({ onHomeClick }) {
    ...
    const plantsArray = [
        ...
        // (Your other plant categories remain unchanged...)
    ];
                    ...
                    <div>
                        <a href="#" onClick={(e) => handleCartClick(e)} style={styleA}>
                            <div style={{ position: 'relative' }}>
                                ...
                                {/* RED BADGE FOR TOTAL CART QUANTITY */}
                                {totalQty > 0 && (
                                    <span
                                        style={{
                                            position: 'absolute',
                        ...
                        <div key={index}>
                            ...
                            <div className="product-list">
                                {category.plants.map((plant, plantIndex) => (
                                    <div className="product-card" key={`${category.category}-${plant.name}-${plantIndex}`}>
